...
> These are my notes on what I plan to teach in each [**upcoming class**](#dec-08). Also check out the [**Brightspace Quizzes**](#quiz-links) and the [**Draft Planning Calendar**](./Calendar.md).
>
...
- **Today**
  ...
  - 🕗 Part B)
    - Logic and Problem Solving
      - The Role of Test Plans
        - Choosing Test Data
          - Simple/easy to compute in your head
          - For the Happy Path
          - For the Sad Path
        - More [Rectangles](./src/015/Rectangles/)
          - Preserving State (on `new Rectangle()`)
          - Calculate Area and Perimeter
          - Invalid Height/Width
      - From Test Plan to Automated Tests
        - Testing the Logic vs. Testing the DOM
